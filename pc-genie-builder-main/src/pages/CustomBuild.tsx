  ...
  const componentOptions = {
    cpu: [
      ...
      },
      {
        ...
        rating: 4.8,
        image: "/placeholder.svg",
        description: "Powerful multi-core CPU for intensive tasks"
      },
      {
        id: "cpu3",
        ...
        rating: 4.7,
        image: "/placeholder.svg",
        description: "Great performance for gaming and productivity"
      }
    ],
    gpu: [
      {
        ...
        rating: 4.9,
        image: "/placeholder.svg",
        description: "Top-tier graphics card for 4K gaming and rendering"
      },
      {
        id: "gpu2",
        ...
        rating: 4.7,
        image: "/placeholder.svg",
        description: "High-performance GPU with excellent value"
      },
      {
        id: "gpu3",
    ...
    psu: [
      {
        ...
        rating: 4.7,
        image: "/placeholder.svg",
        description: "850W Gold-rated fully modular power supply"
      }
    ],
    case: [
      {
        ...
        rating: 4.9,
        image: "/placeholder.svg",
        description: "Spacious case with excellent airflow"
      }
    ],
    cooling: [
      {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {componentOptions[
                  ...
                  <Card
                    ...
                    onClick={() =>
                      updateCustomComponent(
                        category.id as keyof typeof customBuild,
                        component
                      )
                    }
                  >
        ...
        <div className="mt-8 bg-secondary/20 p-6 rounded-lg">
          ...
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              disabled={
                !Object.values(customBuild).every(
                  (component) => component !== null
                )
              }
            >
