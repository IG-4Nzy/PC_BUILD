...
import { ArrowLeft, Printer, Share2, Download, Check, ShoppingCart } from "lucide-react";
...
const FinalSelection = () => {
  ...
  const retailers = [
    { id: "1", name: "TechGalaxy", price: finalBuild.price, inStock: true, deliveryDays: 3 },
    { id: "2", name: "ComputerWorld", price: finalBuild.price + 25, inStock: true, deliveryDays: 2 },
    { id: "3", name: "PCPartZone", price: finalBuild.price - 15, inStock: false, deliveryDays: 5 },
    { id: "4", name: "Hardware Hub", price: finalBuild.price + 10, inStock: true, deliveryDays: 4 }
  ];
      ...
      >
        <div className="flex items-center mb-8">
          <Button 
            variant="ghost" 
            size="icon" 
            onClick={() => navigate(isCustomBuild ? '/custom' : `/builds/${finalBuild.id}`)}
            className="mr-2"
          >
        ...
        <Alert className="mb-8 bg-green-500/10 border-green-500">
          ...
          <AlertDescription>
            Your PC configuration is complete and ready for purchase. All components are compatible.
          </AlertDescription>
        </Alert>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">{finalBuild.performanceScore}/100</p>
                  </div>
                </div>

                <div className="space-y-4">
                  {Object.entries(finalBuild.components).map(([key, component]) => (
